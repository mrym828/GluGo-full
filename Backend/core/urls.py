...
from core.services.api import FoodEntryViewSet, GlucoseRecordViewSet, InsulinDoseViewSet, QuickGlucosePredictionView
...
router.register(r'insulin-doses', InsulinDoseViewSet)
